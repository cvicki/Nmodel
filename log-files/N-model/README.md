...
###### d3_3:
Description: Simplifying value function by having the discount factor be only $\gamma$ (as opposed to $\lambda \times \gamma$). Adv. fun same as algo 1. 
...
###### d3_4, d3_42:
Description: Modified algo 2 value function. Changed discount factor to $\gamma \times \lambda$ (previously $\gamma$). Adv. function same as algo 1. 
...
###### d4:
Description: Value function is modified algo 2 with $\gamma \times \lambda $ as discount factor. Used algo 2 for advantage function estimate. 
